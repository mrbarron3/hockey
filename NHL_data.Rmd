...
plot_scatter = function(df) {
  ggplot(df) +
    geom_point(aes(shots, goals, shape = selected, color = name)) +
...
ui <- fluidPage(
  ...
  titlePanel("Hockey Game Stats Explorer"),
  sidebarLayout(
    sidebarPanel(
